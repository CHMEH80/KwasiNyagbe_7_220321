...
exports.create = async (req, res) => {
  ...
  try {
    ...
    if (id != req.body.id) throw( {status: 500, msg : "requête incohérente"});
    if (dataUser === null) throw( {status: 400, msg : "l'utilisateur n'existe pas"});
    if (req.body.content === null) throw( {status: 400, msg : "Rien à publier"});
    console.log("------------------------------------",id)
